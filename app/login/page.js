...
const Login = () => {
  ...
  return (
    <section className="flex flex-col md:flex-row h-screen items-center">
      <div className="bg-[#083D77] hidden lg:block w-full md:w-1/2 xl:w-2/3 h-screen">
        <div className="flex items-center justify-center mt-10 h-screen">
          ...
          >
            ...
            <path
              ...
              fill="#ccc"
            ></path>
            <circle cx="524.99994" cy="335.5" r="16" fill="#da4167"></circle>
            <polygon
        ...
        <div className="w-full h-100">
          ...
          <form className="mt-6" onSubmit={handleSubmit}>
            ...
            <div className="text-left mt-2">
              <button className="text-sm font-semibold text-gray-300 hover:text-blue-700 focus:text-blue-700">
                Forgot Password?
              </button>
            </div>
            <button
